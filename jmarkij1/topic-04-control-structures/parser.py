...
def test_parse_if_statement():
    ...
    assert ast == {
        'tag': 'if', 'condition': {'tag': 'number', 'value': 1, 'position': 3}, 'then': {'tag': 'print', 'value': {'tag': 'number', 'value': 2, 'position': 11}}
    }
    ast, tokens = parse_if_statement(tokenize("if(1)print(2)elseprint(3)"))
    assert ast == {
        'tag': 'if', 'condition': {'tag': 'number', 'value': 1, 'position': 3}, 'then': {'tag': 'print', 'value': {'tag': 'number', 'value': 2, 'position': 11}}, 'else': {'tag': 'print', 'value': {'tag': 'number', 'value': 3, 'position': 23}}
    }
    ast, tokens = parse_if_statement(tokenize("if(1){print(2);print(-2)}elseprint(3);print(-3)}"))
    assert ast == {
        'tag': 'if', 'condition': {'tag': 'number', 'value': 1, 'position': 3}, 'then': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'number', 'value': 2, 'position': 12}}, 'list': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'negate', 'value': {'tag': 'number', 'value': 2, 'position': 22}}}, 'list': None}}, 'else': {'tag': 'print', 'value': {'tag': 'number', 'value': 3, 'position': 35}}
    }
